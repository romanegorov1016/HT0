...
public class Room {
    ...
    public String getFurnitureList() {
		 return furniture_list.toString().replaceAll("\\[", "").replaceAll("\\]","").replaceAll("\\,", "");
    }
    ...
    public void add(String furniture_name, double furniture_area) { //Adding furniture by name and area
